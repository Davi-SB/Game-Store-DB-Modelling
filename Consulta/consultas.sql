...
--SUBCONSULTA DO TIPO LINHA (QUAIS OS NOMES DOS JOGOS FORAM LANÇACOS NA MESMA DATA QUE O JOGO DE ID '101'
SELECT J.NOME
FROM JOGO J
...
SELECT * FROM (SELECT USUARIO_ID FROM DEV) UNION (SELECT USUARIO_ID FROM PLAYER);
